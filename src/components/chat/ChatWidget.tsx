...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className={`fixed bottom-20 right-4 sm:right-6 w-[95%] sm:w-96 h-[70vh] sm:h-[600px]
            bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800
            rounded-2xl shadow-2xl z-40 flex flex-col border border-gray-700/60 
            overflow-hidden backdrop-blur-xl transition-all duration-300 ease-out 
            sm:scale-100 scale-95 sm:bottom-24
          `}
        >
          {/* Header */}
          <div className="relative bg-gradient-to-r from-blue-700 via-cyan-600 to-sky-500 p-4 flex items-center gap-3 shadow-lg">
            <div className="relative w-10 h-10 sm:w-12 sm:h-12 bg-white/10 rounded-full flex items-center justify-center border border-white/20">
            ...
            <div className="relative">
              <h3 className="font-semibold text-white tracking-wide flex items-center gap-2 text-sm sm:text-base">
                Vertex
            ...
            <div className="ml-auto">
              <div className="px-2 py-1 bg-white/10 rounded-lg border border-white/20 flex items-center gap-1">
                ...
                <span className="text-[9px] sm:text-[10px] text-white font-mono">v2.0</span>
              </div>
            </div>
          </div>
              ...
              {isLoading && (
                <div className="flex gap-3 p-4 bg-gradient-to-r from-blue-900/30 to-transparent backdrop-blur-sm">
                  <div className="relative w-8 h-8 sm:w-10 sm:h-10">
                    ...
                    <div className="relative w-full h-full rounded-full bg-gradient-to-br from-blue-600 to-cyan-500 flex items-center justify-center shadow-lg">
                      <Loader2 className="w-4 h-4 sm:w-5 sm:h-5 text-white animate-spin" />
                    </div>
                  </div>
                  <div className="flex items-center gap-2 text-gray-200 text-xs sm:text-sm font-mono">
                    Processing request
